...
public class AuditeurCNAM {
    ...
    public String login() {
        ...
        //si le nom de l etudiant est plus petit que 6 charactère on le prend en tout
        String lastNameUsed=nom.length()>6?nom.substring(0,6):nom;
        login=lastNameUsed +"_"+prenom.charAt(0);
